...
const svgElement = button.querySelector("svg"); // Target the existing SVG

const sunSVG = `<svg class="inline-graphic toggle-thingy" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 256 256"><path fill="none" d="M0 0h256v256H0z"/><path fill="none" stroke="var(--primary-color" stroke-linecap="round" stroke-linejoin="round" stroke-width="18" d="M128 40V16"/><circle cx="128" cy="128" r="56" fill="none" stroke="var(--primary-color" stroke-linecap="round" stroke-linejoin="round" stroke-width="22"/><path fill="none" stroke="var(--primary-color" stroke-linecap="round" stroke-linejoin="round" stroke-width="22" d="M64 64 48 48M64 192l-16 16M192 64l16-16M192 192l16 16M40 128H16M128 216v24M216 128h24"/></svg>`;
